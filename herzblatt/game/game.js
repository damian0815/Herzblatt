...
var config = {
    ...
    scene: [ titleScene, characterSelectScene, dialogueScene, loadingScene, bachelorScene, candidateScene, questionIntroScene, questionScene, revealBachelorScene, revealDecisionScene, youLostScene, youWonScene ]
};
