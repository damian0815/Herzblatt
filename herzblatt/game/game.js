...
var config = {
    ...
    scene: [ titleScene, characterSelectScene, loadingScene, bachelorScene, candidateScene, questionIntroScene, questionScene, revealBachelorScene, revealDecisionScene, youLostScene, youWonScene ]
};
